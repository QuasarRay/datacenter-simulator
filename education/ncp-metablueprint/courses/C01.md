...
1. Complete the linked C01-NETBOX practical: compile the live read-only NetBox scope into Incus, patchbay and generated guest networking with native_fabric. Compare IDs, ports, cable endpoints, routes and snapshot digests.
