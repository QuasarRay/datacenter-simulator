...
def main():
    ...
    ctx = dict(dc=dc, fabric_intent=want, inventory_hostname='spine1', ansible_host='172.30.0.11',
               ...
               scm_branch='main', project_prefix='cheatsheets/ex457/v6', ee_image='registry.example.net/ee@sha256:'+'a'*64,
               ...
               credential_filename_namespace='tower', machine_key_passphrase='fixture', omit='OMIT', existing_workflow_nodes={'json': {'results': [{'identifier': 'obsolete'}]}}, remote_node=want['remote_nodes'][0], diagnostic_command='show version')
