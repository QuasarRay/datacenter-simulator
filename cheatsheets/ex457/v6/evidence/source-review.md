...
[Hypothesis settings and stateful tests](https://hypothesis.readthedocs.io/en/latest/stateful.html)

Authority: Hypothesis maintainers. Version/scope: 6.168.0 installed; documentation current.

Locator: RuleBasedStateMachine; rules and invariants.

Review note: Generated examples exercise a defined input space; state machines explore sequences. They are not a universal proof.

## PYATS

[Cisco pyATS AEtest](https://devnet-pubhub-site.s3.amazonaws.com/media/pyats/docs/aetest/run.html)

Authority: Cisco. Version/scope: 26.8 installed.

Locator: Standalone execution and programmatic results.

Review note: Test section results must be propagated to the process gate; local deliberate-failure probe verifies nonzero exit.

## DAGGER-CI

[Dagger GitHub Action pinned source](https://github.com/dagger/dagger-for-github/tree/27b130bf0f79a7f6fbbbe0fbca6760dc9bb40a77)

Authority: Dagger maintainers. Version/scope: 8.4.1 action; 0.21.8 engine.

Locator: README inputs: module, call, version.

Review note: Dagger functions can be invoked by a GitHub Actions step; result export and failure enforcement are separate functions here.

## GHA-SECURITY

[GitHub Actions secure use](https://docs.github.com/en/actions/reference/security/secure-use)

Authority: GitHub. Version/scope: current official guide.

Locator: Pinning actions; token permissions; untrusted input.

Review note: Full commit SHAs pin action code; the workflow uses contents:read, no persistent checkout credential and an ephemeral hosted runner.

## AWX-INJECTOR-SOURCE

[AWX 24.6.1 actual credential injector](https://github.com/ansible/awx/blob/24.6.1/awx/main/models/credential/__init__.py)

Authority: Ansible AWX maintainers. Version/scope: 24.6.1; SHA256 in test.

Locator: CredentialType.inject_credential.

Review note: The pinned implementation provides tower.filename; the real method is executed with synthetic model fields in a regression test.
